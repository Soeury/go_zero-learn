...
var (
	...
	cacheZeroUserUserIdPrefix   = "cache:zero:user:userId:"
	cacheZeroUserUsernamePrefix = "cache:zero:user:username:"
)
...
func (m *defaultUserModel) Delete(ctx context.Context, id int64) error {
	...
	}, zeroUserIdKey, zeroUserUserIdKey, zeroUserUsernameKey)
	return err
}
...
func (m *defaultUserModel) FindOneByUserId(ctx context.Context, userId int64) (*User, error) {
	...
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, zeroUserUserIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
